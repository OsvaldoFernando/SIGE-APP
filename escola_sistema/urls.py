...
urlpatterns = [
    ...
    path('inscricao/<slug:curso_slug>/', views.inscricao_create, name='inscricao_create'),
    ...
    path('salas/', views.gerir_salas, name='gerir_salas'),
    path('salas/novo/', views.criar_sala, name='criar_sala'),
    path('salas/<int:sala_id>/editar/', views.editar_sala, name='editar_sala'),
    path('salas/<int:sala_id>/deletar/', views.deletar_sala, name='deletar_sala'),
    ...
    path('api/verificar-username/', views.verificar_username_disponivel, name='verificar_username'),
